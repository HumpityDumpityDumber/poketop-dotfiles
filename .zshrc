...
# Extract Pokémon name from ~/hyprmon/colors.json and run pokemon-colorscripts
pokemon_name=$(jq -r '.name' ~/poketop/pokemon.json)
pokemon-colorscripts -n "$pokemon_name"